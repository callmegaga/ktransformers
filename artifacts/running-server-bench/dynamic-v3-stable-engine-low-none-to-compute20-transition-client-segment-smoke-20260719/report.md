...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| p1024-o600 | 1 | 1046.0 | 600.0 | 161.67 [161.67, 161.67] | 15.92 [15.92, 15.92] | 6470.11 [6470.11, 6470.11] | 62.81 [62.81, 62.81] | 37624.70 | 44094.82 | 44094.88 |
...
|---|---:|---:|---:|---:|---:|
| p1024-o600 | 0.8366 | 0.6625 | 0.1545 | 0.0197 | 0.1020 |
...
|---|---:|---:|---:|---:|---:|---:|
| p1024-o600 | 0.0000 | 0.0001 | 0.0000 | 0.7267 | 0.5940 | 0.0000 |
...
- Background ready delay: 49.27 ms
- Background stopped after request: True
- Decode calls before launch: 151
- First iGPU execution delay: 13 calls / 1791.61 ms
- Settled iGPU delay: 13 calls / 1791.61 ms
- Client pre-transition throughput: 26.93 token/s
- Client post-transition throughput: 13.96 token/s
