...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| p1024-o600 | 1 | 1046.0 | 600.0 | 169.58 [169.58, 169.58] | 18.00 [18.00, 18.00] | 6168.06 [6168.06, 6168.06] | 55.55 [55.55, 55.55] | 33272.85 | 39440.91 | 39441.01 |
...
|---|---:|---:|---:|---:|---:|
| p1024-o600 | 0.8314 | 0.6497 | 0.1601 | 0.0215 | 0.0949 |
...
|---|---:|---:|---:|---:|---:|---:|
| p1024-o600 | NA | 0.0117 | 0.0000 | 0.7429 | 0.5841 | 0.0000 |
...
- Background ready delay: 446.47 ms
- Background stopped after request: True
- Decode calls before launch: 149
- First iGPU execution delay: 5 calls / 1062.45 ms
- Settled iGPU delay: 5 calls / 1062.45 ms
- Client pre-transition throughput: 29.18 token/s
- Client post-transition throughput: 15.98 token/s
